...
#define METADATA_ADDRESS                    ((uint32_t)0x08006800) // next 2 KB page after 26 KB bootloader
#define APPLICATION_ADDRESS        			((uint32_t)0x08007000) // 100 KB application region after metadata
