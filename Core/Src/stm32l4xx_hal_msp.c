...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    PB6     ------> I2C1_SCL
    */
    GPIO_InitStruct.Pin = GLOBAL_SDA_Pin|GLOBAL_SCL_Pin;
  ...
  */
    ...
    PB11     ------> I2C2_SDA
    */
    GPIO_InitStruct.Pin = LOCAL_SCL_Pin|LOCAL_SDA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C1)
  {
    ...
    PB6     ------> I2C1_SCL
    */
    HAL_GPIO_DeInit(GLOBAL_SDA_GPIO_Port, GLOBAL_SDA_Pin);

    HAL_GPIO_DeInit(GLOBAL_SCL_GPIO_Port, GLOBAL_SCL_Pin);
  ...
  else if(hi2c->Instance==I2C2)
  {
    ...
    PB11     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(LOCAL_SCL_GPIO_Port, LOCAL_SCL_Pin);

    HAL_GPIO_DeInit(LOCAL_SDA_GPIO_Port, LOCAL_SDA_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PA2     ------> USART2_TX
    */
    GPIO_InitStruct.Pin = CALL_IN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART2;
    HAL_GPIO_Init(CALL_IN_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PC10     ------> USART3_TX
    */
    GPIO_InitStruct.Pin = CALL_OUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART3;
    HAL_GPIO_Init(CALL_OUT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  else if(huart->Instance==USART2)
  {
    ...
    PA2     ------> USART2_TX
    */
    HAL_GPIO_DeInit(CALL_IN_GPIO_Port, CALL_IN_Pin);
  ...
  else if(huart->Instance==USART3)
  {
    ...
    PC10     ------> USART3_TX
    */
    HAL_GPIO_DeInit(CALL_OUT_GPIO_Port, CALL_OUT_Pin);
